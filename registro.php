                            ...
                            <div class="card-body p-4 p-lg-5 ">
                                ...
                                <form method="post" action="registro.php" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" id="nombre" class="form-control form-control-lg" name="nombre" value="<?php
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" id="apellido" class="form-control form-control-lg" name="apellido" value="<?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" id="username" class="form-control form-control-lg" name="username" value="<?php
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="email" id="email" class="form-control form-control-lg" name="email" value="<?php
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="password" id="password" class="form-control form-control-lg" name="password" value="<?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input class="form-check-input" type="radio" name="tipoUsuario" value="artista" id="tipoArtista"checked>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input class="form-check-input" type="radio" name="tipoUsuario" value="reclutador" id="tipoReclutador">
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-dark btn-lg btn-block" type="submit" name="sign-up">Entrar</button>
                                </form>

                                <p class="mb-5 pb-lg-2 already-account">¿Ya tienes una cuenta?
                                        <form method="post">
