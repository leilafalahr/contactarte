...
if (isset($_POST['sign-up'])) {
    ...
    //Recibimos y filtramos los datos que recibimos del formulario
    $nombre = filter_var($_POST['nombre'],FILTER_SANITIZE_STRING);
    $nombre = ucfirst(strtolower($nombre));//Pone la primera letra en mayúscula
    $_SESSION['nombre'] = $nombre; //Recupera la variable de la sesión anterior

    $apellido = filter_var($_POST['apellido'],FILTER_SANITIZE_STRING);
    $apellido = ucfirst(strtolower($apellido));//Pone la primera letra en mayúscula
